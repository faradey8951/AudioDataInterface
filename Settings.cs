    ...
    public class Settings
    {
        ...
        public static void Load()
        {
            try
            {
                ...
                form_main.window_main.инвертироватьСигналToolStripMenuItem.Checked = AudioIO.audio_invertSignal;
                form_main.window_main.toolStripButton_invert.Checked = AudioIO.audio_invertSignal;
